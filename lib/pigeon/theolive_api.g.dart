...
class THEOliveNativeAPI {
  ...
  Future<void> loadChannel(String arg_channelID) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.theolive_flutter_sample.THEOliveNativeAPI.loadChannel', codec,
  ...
  Future<void> play() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.theolive_flutter_sample.THEOliveNativeAPI.play', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
  ...
  Future<void> pause() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.theolive_flutter_sample.THEOliveNativeAPI.pause', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(null) as List<Object?>?;
    if (replyList == null) {
  ...
  Future<void> preloadChannels(List<String?> arg_channelIDs) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.theolive_flutter_sample.THEOliveNativeAPI.preloadChannels', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
...
abstract class THEOliveFlutterAPI {
  ...
  static void setup(THEOliveFlutterAPI? api, {BinaryMessenger? binaryMessenger}) {
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.theolive_flutter_sample.THEOliveFlutterAPI.onChannelLoadedEvent', codec,
      ...
      if (api == null) {
        ...
        channel.setMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.theolive_flutter_sample.THEOliveFlutterAPI.onChannelLoadedEvent was null.');
