...
class THEOliveView extends StatelessWidget {

  final Function(THEOliveViewController) onTHEOliveViewCreated;

  const THEOliveView({required Key key, required this.onTHEOliveViewCreated,}) : super(key: key);
          ...
          onCreatePlatformView: (params) {
            return PlatformViewsService.initExpensiveAndroidView(
              ...
              ..addOnPlatformViewCreatedListener((id) {
                ...
                onTHEOliveViewCreated(THEOliveViewController(id));
              })
              ..create();
          },
        );
